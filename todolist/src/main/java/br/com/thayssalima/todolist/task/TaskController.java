package br.com.thayssalima.todolist.task;
...
import br.com.thayssalima.todolist.utils.utils;
...
public class TaskController {
    ...
    @PathVariable UUID id, HttpServletRequest request ){
        ...
        if (!task.getIdUser().equals(idUser)){
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Usuário não tem permissão para aletrar essa tarefa");
